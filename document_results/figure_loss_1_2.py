...
data = pd.read_csv("run-Nov11_12-54-53_juansosa-Lenovo-Legion-Y7000P-1060-tag-Loss.csv")
data = data.fillna(value=0)

data2 = pd.read_csv("run-Nov21_06-48-58_juansosa-Lenovo-Legion-Y7000P-1060-tag-Loss.csv")
